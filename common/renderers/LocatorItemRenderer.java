package vCraft.common.renderers;
...
public class LocatorItemRenderer
{
    ...
    public LocatorItemRenderer(FontRenderer par1FontRenderer, GameSettings par2GameSettings, RenderEngine par3RenderEngine)
    {
